...
namespace UI.Migrations
{
    ...
    [Migration("20250310193512_initialion")]
    partial class initialion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UI.Models.AspNetRole", b =>
                {
            ...
            modelBuilder.Entity("UI.Models.AspNetRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UI.Models.AspNetUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UI.Models.AspNetUserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UI.Models.AspNetUserLogin", b =>
                {
            ...
            modelBuilder.Entity("UI.Models.AspNetUserToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UI.Models.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("UI.Models.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("UI.Models.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("UI.Models.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UI.Models.TbItem", b =>
                {
                    b.Property<int>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UI.Models.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("UI.Models.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("UI.Models.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UI.Models.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UI.Models.TbPage", b =>
                {
            ...
            modelBuilder.Entity("UI.Models.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("UI.Models.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("UI.Models.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UI.Models.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UI.Models.TbSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UI.Models.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("UI.Models.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UI.Models.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UI.Models.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UI.Models.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("UI.Models.VwSalesInvoice", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AspNetUserRole", b =>
                {
                    b.HasOne("UI.Models.AspNetRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UI.Models.AspNetUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("UI.Models.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UI.Models.TbItem", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UI.Models.AspNetRoleClaim", b =>
                {
                    b.HasOne("UI.Models.AspNetRole", "Role")
            ...
            modelBuilder.Entity("UI.Models.AspNetUserClaim", b =>
                {
                    b.HasOne("UI.Models.AspNetUser", "User")
            ...
            modelBuilder.Entity("UI.Models.TbBusinessInfo", b =>
                {
                    b.HasOne("UI.Models.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("UI.Models.TbBusinessInfo", "CutomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UI.Models.TbItem", b =>
                {
                    b.HasOne("UI.Models.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("UI.Models.TbItemType", "ItemType")
                        .WithMany("TbItems")
                        .HasForeignKey("ItemTypeId")
                        .HasConstraintName("FK_TbItems_TbItemTypes");

                    b.HasOne("UI.Models.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("UI.Models.TbItemDiscount", b =>
                {
                    b.HasOne("UI.Models.TbItem", "Item")
            ...
            modelBuilder.Entity("UI.Models.TbPurchaseInvoice", b =>
                {
                    b.HasOne("UI.Models.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("UI.Models.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("UI.Models.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("UI.Models.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("UI.Models.TbSalesInvoice", "Invoice")
