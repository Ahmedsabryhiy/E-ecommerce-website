...
namespace UI.Migrations
{
    ...
    [Migration("20250311053340_IdentitySyestem")]
    partial class IdentitySyestem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BL.ApplicationUsers", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbItem", b =>
                {
                    b.Property<int>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbPage", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FaseBookLink")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("MiddelPanner")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TiwetterLink")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("YouTupekLink")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.VwSalesInvoice", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.TbItemDiscount", b =>
                {
                    b.HasOne("LapShop.Domain.Entities.TbItem", "Item")
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbBusinessInfo", b =>
                {
                    b.HasOne("LapShop.Domain.Entities.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("LapShop.Domain.Entities.TbBusinessInfo", "CutomerId")
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbItem", b =>
                {
                    b.HasOne("LapShop.Domain.Entities.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("LapShop.Domain.Entities.TbItemType", "ItemType")
                        .WithMany("TbItems")
                        .HasForeignKey("ItemTypeId")
                        .HasConstraintName("FK_TbItems_TbItemTypes");

                    b.HasOne("LapShop.Domain.Entities.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbPurchaseInvoice", b =>
                {
                    b.HasOne("LapShop.Domain.Entities.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("LapShop.Domain.Entities.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("LapShop.Domain.Entities.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("LapShop.Domain.Entities.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BL.ApplicationUsers", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("LapShop.Domain.Entities.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LapShop.Domain.Entities.TbItem", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
